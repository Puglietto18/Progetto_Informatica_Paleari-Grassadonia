...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tabCandela;
    private TextView tabCarburatori;
    ...
    private void initViews(){
        ...
        tabCandela = findViewById(R.id.tabCandela);
        tabCarburatori = findViewById(R.id.tabCarburatori);
    }
    ...
    private void initListaCategorie(){
        listaCategorie.addAll(Arrays.asList(
                tabMotore,
                tabCandela,
                tabCarburatori,
                tabScarichi
    ...
    private void selezionaCategoria(TextView tabSelezionata){
        ...
        switch (categoriaSelezionata.toLowerCase()){

            case "motore":
                titoloSezione.setText("Pistoni, cilindri e teste disponibili");
                break;

            case "candela":
                titoloSezione.setText("Candele disponibili");
                break;

            case "carburatori":
                titoloSezione.setText("Carburatori e iniettori disponibili");
                break;

            case "scarichi":
                titoloSezione.setText("Pance, collettori e silenziatori disponibili");
                break;
        }
    ...
    private void filtraProdottiPerCategoria(String categoriaSelezionata){
        ...
        for(Prodotto prodotto : listaProdotti){
            ...
            String nome = prodotto.getNome().toLowerCase();

            switch (categoriaSelezionata.toLowerCase()){

                case "motore":
                    if(nome.contains("cilindro") || nome.contains("testa")){
                        listaProdottiFiltrati.add(prodotto);
                    }
                    break;

                case "candela":
                    if(nome.contains("candela")){
                        listaProdottiFiltrati.add(prodotto);
                    }
                    break;

                case "carburatori":
                    if(nome.contains("carburatore") ||
                            nome.contains("iniettori") ||
                            nome.contains("iniettore")){
                        listaProdottiFiltrati.add(prodotto);
                    }
                    break;

                case "scarichi":
                    if(nome.contains("pancia") ||
                            nome.contains("collettore") ||
                            nome.contains("silenziatore")){
                        listaProdottiFiltrati.add(prodotto);
                    }
                    break;
            }
